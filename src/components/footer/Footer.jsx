...
export default function Footer() {
  return (
    ...
    <Row className='text-footer'>
      <Col sm><img src={logo} alt="" /></Col>
      <Col sm><h5>Pizzeria Don Remolo</h5></Col>
      <Col sm><h6>Servicio al cliente</h6></Col>
      <Col sm><h6>¿Cómo comprar?</h6></Col>
      <Col sm><h6>Condiciones de uso</h6></Col>
